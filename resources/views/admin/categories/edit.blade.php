...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex">
    ...
    <main class="flex-1 flex items-center justify-center p-4 md:p-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg w-full max-w-lg border border-gray-200 dark:border-gray-700">
            <h1 class="text-3xl md:text-4xl font-bold mb-6 text-blue-700 dark:text-blue-300 flex items-center gap-3"><i class="bi bi-tags"></i> Edit Kategori</h1>
            <form method="POST" action="{{ route('categories.update', $category) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" autofocus value="{{ old('name', $category->name) }}" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white @error('name') border-red-500 ring-2 ring-red-300 @enderror" required>
