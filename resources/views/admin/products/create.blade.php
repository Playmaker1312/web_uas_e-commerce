...
<head>
    ...
    <title>Tambah Produk | Admin FlashMart</title>
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex">
    ...
    <main class="flex-1 flex items-center justify-center p-4 md:p-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg w-full max-w-2xl border border-gray-200 dark:border-gray-700">
            <h1 class="text-3xl md:text-4xl font-bold mb-6 text-blue-700 dark:text-blue-300 flex items-center gap-3"><i class="bi bi-box-seam"></i> Tambah Produk</h1>
            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="price" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" required>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 dark:text-gray-200 font-semibold mb-2">Stok</label>
                    <input type="number" name="stock" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" required>
                </div>
                <div class="mb-4">
                    ...
                    <img id="img-preview" class="mt-2 w-24 h-24 object-cover rounded shadow hidden" />
                </div>
