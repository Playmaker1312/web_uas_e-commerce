...
<body class="min-h-screen flex bg-gradient-to-br from-[#232946] to-[#1a223f]">
    ...
    <main class="flex-1 flex flex-col min-h-screen px-2 md:px-8 py-4">
        ...
        <div class="flex flex-col items-center justify-center flex-1">
            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" class="form-glass relative">
                <h1><i class="bi bi-box-seam"></i> Tambah Produk</h1>
                @csrf
                @if ($errors->any())
                ...
                <div class="mb-8 relative">
                    <input type="text" name="name" id="name" autofocus class="input-glass peer" required value="{{ old('name') }}" placeholder=" " />
                ...
                <div class="mb-8 relative">
                    <input type="number" name="price" id="price" class="input-glass peer" required placeholder=" " />
                ...
                <div class="mb-8 relative">
                    <input type="number" name="stock" id="stock" class="input-glass peer" required placeholder=" " />
