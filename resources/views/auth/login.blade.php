...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex flex-col">
    ...
    <header class="w-full bg-white dark:bg-gray-800 shadow-sm py-4 px-6 md:px-12 flex items-center justify-between sticky top-0 z-50 rounded-b-lg">
        ...
        <!-- Search Bar (Responsive) - Hidden on login page as it's not the primary function -->
        ...
        <!-- User Actions (Cart, Profile) - Logout button is not present on login page -->
    ...
    <main class="flex-1 w-full flex items-center justify-center px-4 py-8">
        <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
            <h2 class="text-3xl font-bold mb-8 text-center text-blue-700 dark:text-blue-300">Masuk ke Akun Anda</h2>
            ...
            <form action="/login" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" required autofocus>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <span class="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-gray-400" onclick="togglePassword()">
                            <i class="bi bi-eye" id="togglePasswordIcon"></i>
                        </span>
                    </div>
                    <div class="flex justify-end mt-2">
                        <a href="/password/reset" class="text-blue-600 hover:underline text-sm">Lupa Password?</a>
                    </div>
                </div>
            ...
            <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">Belum punya akun? <a href="/register" class="text-blue-600 hover:underline font-medium">Daftar Sekarang</a></p>
        </div>
    </main>
